...
public class SosService {
	...
	public GetFeatureOfInterestResponse getFeatureOfInterest(String json) {
		...
		return (GetFeatureOfInterestResponse) Common.jsonToObject(sosRepository.request(json),
				GetFeatureOfInterestResponse.class);
	}

	public GetObservationByIdResponse getObservationById(String json) {

		return (GetObservationByIdResponse) Common.jsonToObject(sosRepository.request(json),
